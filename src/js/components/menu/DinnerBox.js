...
class DinnerBox extends Component {
  constructor() {
    super();
    this.state = {
      data: data.dinner_box
    };
  }
  // componentDidMount() {
  ...
  renderData = () => {
    return (
      <div className="menu-page container">
        ...
        <h5>
          <em>Served with miso soup, ebi sunomono salad (Rice optional)</em>
        </h5>
        <h5>
          <em>* veggie sunomono for Dinner Box D</em>
        </h5>

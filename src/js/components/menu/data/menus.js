const data = {
  appetizer: [
    ...
    },
    {
      ...
      price: 11.95,
      url: '/images/menu/appetizer/appetizer_sashimi.jpg',
      group: 1
    },
    {
    ...
    {
      name: 'Agedashi Tofu (16pcs)',
      id: 9,
      description: '(Deep fried tofu)',
      price: 4.5,
      url: '/images/menu/appetizer/agedashi_tofu.jpg',
      group: 2
    },
    {
      name: 'Takoyaki (6pcs)',
  ...
  boat: [
    ...
    },
    {
      ...
      price: 44.95,
      url: '/images/menu/boat/love_boat.jpg',
      group: 2
    }
  ],
  dessert: {
  ...
  sashimi: [
    ...
    {
      name: 'Unagi Sashimi(10pcs)',
      id: 7,
      description: '(BBQ eel)',
      price: '(half) $9.50 / $17.95',
      url: '/images/menu/sashimi/unagi_sashimi.jpg',
      group: 1
    },
    {
      ...
      price: 45.95,
      url: '/images/menu/sashimi/deluxe_sashimi.jpg',
      group: 1
    }
  ],
  soupAndSalad: [
  ...
  udon: [
    ...
    },
    {
      name: 'Tempura Udon',
      id: 4,
      description: '(2pcs prawn & 4pcs vege tempura)',
      price: 11.95,
